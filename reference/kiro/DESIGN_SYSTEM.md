...
Measured from the rendered `https://kiro.dev/` homepage on 26 August 2026. These are design observations, not copied source or brand assets. Ari keeps its own identity and product content.

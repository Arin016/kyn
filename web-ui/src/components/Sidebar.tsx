...
interface Props {
  ...
  onClose: () => void;
  onNewBot: () => void;
  workspace: "conversation" | "inbox" | "workflows" | "tasks" | "plugins";
  onWorkspaceChange: (workspace: "conversation" | "inbox" | "workflows" | "tasks" | "plugins") => void;
}
      ...
      <div className="sidebar-inner">
        <div className="sidebar-top">
          <div className="sidebar-brand">
            <AriGlyph className="sidebar-brand-mark" size={24} finish="silver" />
            <span style={{ fontSize: "0.8rem", fontWeight: 600, color: "var(--fg-muted)" }}>Ari</span>
          </div>
          <button
            type="button"
              ...
              >
                ...
                <span className="side-item-copy">
                  ...
                  <span className="side-item-meta">
                    ...
                    <span className="side-item-meta-text">
                      {bot.model || bot.agent || bot.cwd || "Agent bot"}
                    </span>
                  </span>
                </span>
              </button>
